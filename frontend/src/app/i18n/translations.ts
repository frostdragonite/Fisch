...
export const TRANSLATIONS = {
  th: {
    ...
    'dashboard.saveTitle': 'เซฟ / โหลด',
    'dashboard.saveHint':
      'แต่ละเครื่องมี Save ID ของตัวเอง — ใส่ ID จากเครื่องอื่นเพื่อโหลด progress นั้น',
    'dashboard.currentSave': 'Save ID ปัจจุบัน',
    'dashboard.loadPlaceholder': 'วาง Save ID...',
    'dashboard.loadSave': 'โหลด',
  ...
  en: {
    ...
    'dashboard.saveTitle': 'Save / Load',
    'dashboard.saveHint':
      'Each device has its own Save ID — paste an ID from another device to load that progress',
    'dashboard.currentSave': 'Current Save ID',
    'dashboard.loadPlaceholder': 'Paste Save ID...',
    'dashboard.loadSave': 'Load',
